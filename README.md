...
<p>A classe PipelineDraweeController é uma outra maneira de fazer o controle de carregamento de imagens, assim como a classe DraweeController. A diferença é que elas usam outras threads e armazena tudo em três caches</p>
<div class="highlight"><pre><code class="language-java" data-lang="java"><span class="n">
